...
export interface TripleDocument {
   ...
   *                There are two optional properties of the `options` parameter that you can set to
   *                influence the shape of this identifier:
   *                 - `identifierPrefix`: a string that will be prepended before this Subject's
   *                                       identifier, whether it's autogenerated or not.
   *                 - `identifier`: if you want full control over what this Subject's identifier
   *                                 will be, you can set it here.
