...
export interface TripleDocument {
   ...
   *
   * @param options By default, Tripledoc will automatically generate an identifier with which this
   *                Subject can be identified within the Document, and which is likely to be unique.
   *                If passed, the `options` parameter can be used to customise the Subject's
   *                identifier.
   * @param options.identifier If set, Tripledoc will not automatically generate an identifier that
   *                           is likely to be unique. Instead, the value of this parameter will be
   *                           used as the Subject's identifier.
   * @param options.identifierPrefix A string that, if set, will be prepended before this Subject's
   *                                 identifier, whether it's autogenerated or not.
   * @returns A Subject instance that can be used to define its properties.
   */
   ...
   *
   * @param typeRef IRI of the type the desired Subjects should be of.
   ...
   *
   * @param subjects Optional array of specific Subjects within this Document that should be written
   *                 to the Pod, i.e. excluding Subjects not in this array.
